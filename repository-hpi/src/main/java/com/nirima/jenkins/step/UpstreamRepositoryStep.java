...
public class UpstreamRepositoryStep extends Step {
    ...
    private final SelectionType upstream;
        ...
        return new SynchronousStepExecution<Void>(context) {
            ...
            protected Void run() throws Exception {
                ...
                try {
                    ...
                    throw new IllegalStateException("Unable to construct the upstream repository URL", e);
                }
                return null;
            }
        };
    ...
    protected EnvironmentContributingAction getEnvContributingAction(String repositoryUrl) {
